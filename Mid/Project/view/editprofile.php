...
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($counter == 0) {
      ...
      $user = fopen("../data/users.txt", "a") or die("Unable to open file!");
  ...
  <form style="display:flex; flex-direction:column; align-items:center;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
    <div>
      ...
      <div>
        ...
        <button type="submit" value="Save Form" class="btn btn-success" onClick="document.location.href='infosubmit.php' " > Submit/Update</button>
