...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if($counter == 0) {
    $signup_status = "Profile updated successfully!";
    ...
    $signup_status = "Submission failed!";
    $counter = 0;
  }
}
else {
...
<div style="display:inline-block;">
  ...
  <div>
    ...
    <div>
      <button type="submit" value="Save Form" style="color:green; font-weight:bold">Submit/Update</button>
