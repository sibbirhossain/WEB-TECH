...
<br>
    ...
    <h2 style="text-align: center;">Enter username to change password</h2>
        ...
        <div class="course">
          <div class="course-box-view">
            ...
            <div style="text-align: left; margin-left: 50px;">
              <div class="container">
              <h4 style="margin-left: 5px;"><b>Change Password</b></h4>
          ...
          <small id="cpassword" class="form-text text-muted">Please type the same password.</small>
            ...
            <br>
      <button name="changepassword" id="update" type="submit" value="Save Form" class="btn btn-success "  >Change password</button>
